...
## 0b. Study Existing Design Docs

Read PLAN.md and INTERVIEW.md to understand the full product vision, UX decisions, and design constraints.

## 0c. Review Current Plan
...
- Clear priority order (dependencies first, then by phase)
...
Keep tasks small - one task should be completable in a single build iteration.
...
- **DO reference the specific spec file** for each task
