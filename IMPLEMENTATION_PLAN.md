...
- [x] Create src/App.tsx with router and context providers (spec: ordering-flow.md)
...
- [x] Navigate to /summary = by-drink view default, can toggle to by-person (spec: summary-and-bar.md)
